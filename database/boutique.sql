...
--
-- Host: 127.0.0.1
-- Generation Time: May 13, 2021 at 03:47 AM
...
INSERT INTO `client` (`code_client`, `firstname`, `lastname`, `email`, `password`, `adresse`, `phone_num`, `birth_date`) VALUES
(42, 'Marwan', 'marwan', 'marwan@gmail.com', 'marwan1', 'Casablanca ', '0652336655', '2020-11-19');
...
INSERT INTO `produit` (`ref`, `name`, `type`, `prix`, `shipping`, `manufacturer`, `description`, `image`) VALUES
...
ALTER TABLE `achats`
  ...
  ADD KEY `fk_clientAchat` (`id_client`);
...
ALTER TABLE `order_details`
  ADD PRIMARY KEY (`ref`,`id_order`),
  ADD KEY `order_details_ibfk_2` (`id_order`);
...
--
ALTER TABLE `client`
  MODIFY `code_client` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
...
--
ALTER TABLE `achats`
  ADD CONSTRAINT `fk_clientAchat` FOREIGN KEY (`id_client`) REFERENCES `clients` (`id_client`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `orders`
--
ALTER TABLE `orders`
  ADD CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`code_client`) REFERENCES `client` (`code_client`);

--
-- Constraints for table `order_details`
--
ALTER TABLE `order_details`
  ADD CONSTRAINT `order_details_ibfk_1` FOREIGN KEY (`ref`) REFERENCES `produit` (`ref`),
  ADD CONSTRAINT `order_details_ibfk_2` FOREIGN KEY (`id_order`) REFERENCES `orders` (`id_order`);

--
-- Constraints for table `produit_category`
--
ALTER TABLE `produit_category`
  ADD CONSTRAINT `produit_category_ibfk_1` FOREIGN KEY (`ref`) REFERENCES `produit` (`ref`),
  ADD CONSTRAINT `produit_category_ibfk_2` FOREIGN KEY (`id_category`) REFERENCES `category` (`id_category`);
COMMIT;
